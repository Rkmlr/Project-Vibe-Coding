    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4 sm:pt-24 overflow-y-auto">
      ...
      <div className="relative w-full max-w-md glass-card rounded-2xl p-6 shadow-2xl border border-white/10 animate-fade-in-up duration-200 mb-8 z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Source Select */}
          <div>
            <label htmlFor="sourceId" className="block text-xs font-medium text-brand-muted mb-1.5 uppercase tracking-wider font-mono">Pilih Sumber Dana</label>
            <select
              id="sourceId"
              value={sourceId}
          ...
          {/* Target Select */}
          <div>
            <label htmlFor="targetId" className="block text-xs font-medium text-brand-muted mb-1.5 uppercase tracking-wider font-mono">Pilih Amplop Target</label>
            <select
              id="targetId"
              value={targetId}
          ...
          {/* Amount Input */}
          <div>
            <label htmlFor="amount" className="block text-xs font-medium text-brand-muted mb-1.5 uppercase tracking-wider font-mono">Jumlah Transfer</label>
          ...
          {/* Description Input */}
          <div>
            <label htmlFor="desc" className="block text-xs font-medium text-brand-muted mb-1.5 uppercase tracking-wider font-mono">Keterangan (Opsional)</label>
            <input
              id="desc"
              type="text"
              value={desc}
