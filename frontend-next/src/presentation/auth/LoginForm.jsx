      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {!isLoginMode && (
          <div className="space-y-2">
            <label htmlFor="displayName" className="text-[10px] text-brand-muted uppercase tracking-wider font-mono block">
        ...
        <div className="space-y-2">
          <label htmlFor="email" className="text-[10px] text-brand-muted uppercase tracking-wider font-mono block">
            Alamat Email
          </label>
          <input
            id="email"
        ...
        <div className="space-y-2">
          <label htmlFor="password" className="text-[10px] text-brand-muted uppercase tracking-wider font-mono block">
            Kata Sandi
          </label>
          <input
            id="password"
          ...
          <div className="space-y-4 pt-2 border-t border-white/5">
            ...
            {familyMode === "create" ? (
              <div className="space-y-2 animate-fade-in">
                <label htmlFor="familyName" className="text-[10px] text-brand-muted uppercase tracking-wider font-mono block">
                  Nama Keluarga Baru
                </label>
                <input
                  id="familyName"
              ...
              <div className="space-y-2 animate-fade-in">
                <label htmlFor="inviteCode" className="text-[10px] text-brand-muted uppercase tracking-wider font-mono block">
